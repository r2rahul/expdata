...
__Please note box plots are plotted on random sampled data of 60,000 when number of rows is greater than 60,000__. Since, `sparkline` does not plot box plots for data size bigger than this. Currently, investigating this. 
